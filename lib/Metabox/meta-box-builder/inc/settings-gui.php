	...
	<div class="menu-settings" ng-controller="BuilderController" ng-init="init()">
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th><label for="meta-box-context"><?php esc_html_e( 'Context', 'meta-box-builder' ); ?></th>
					<td>
						<select name="context" id="meta-box-context" ng-model="meta.context">
							<option value="normal"><?php esc_html_e( 'Normal', 'meta-box-builder' ); ?></option>
							<option value="advanced"><?php esc_html_e( 'Advanced', 'meta-box-builder' ); ?></option>
				...
				<tr>
					...
					<td>
						<select name="style" id="meta-box-style" ng-model="meta.style">
							<option value=""><?php esc_html_e( 'Default', 'meta-box-builder' ); ?></option>
							<option value="seamless"><?php esc_html_e( 'Seamless', 'meta-box-builder' ); ?></option>
						</select>
					</td>
				</tr>
