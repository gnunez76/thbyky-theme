...
class Meta_Box_Attribute
{
	...
	static $labels = array(
		'id' 			=> 'ID',
		'desc'			=> 'Description',
		'attrs'			=> 'Custom Attributes (<a href="http://www.metabox.io/docs/meta-box-builder#custom-attributes" target="_blank">see documentation <span class="dashicons dashicons-external custom-attributes__external-icon"></span></a>)',
		'std'			=> 'Default',
